...
const vueuseHead_f4f09096 = defineNuxtPlugin((nuxt) => {
...
const plugin_fa750cae = defineNuxtPlugin((nuxtApp) => {
...
const NuxtChild = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$3]]);
const layouts = {};
...
const routes = [
  {
    "name": "about",
    "path": "/about",
    "file": "/Users/nick/Dev/www/nuxt32-app/nuxt3-app/pages/about.vue",
    "children": [],
  ...
  },
  {
    "name": "index",
    "path": "/",
    "file": "/Users/nick/Dev/www/nuxt32-app/nuxt3-app/pages/index.vue",
    "children": [],
    "component": () => Promise.resolve().then(function() {
      return index;
    })
...
const router_71539e96 = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    console.time("setup");
    const { data } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("https://jsonplaceholder.typicode.com/posts")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` About (internal link that belongs to the Nuxt App) `);
          } else {
            return [
      ...
      _push(`<!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(data), (item) => {
        _push(`<div>${serverRenderer.exports.ssrInterpolate(item.id)} : =&gt; ${serverRenderer.exports.ssrInterpolate(item.title)}</div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const _sfc_main = {
  __ssrInlineRender: true,
  setup(__props) {
    const name = vue_cjs_prod.ref("Nick 333");
    const jora = vue_cjs_prod.ref("jora");
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = vue_cjs_prod.resolveComponent("NuxtLink");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}> Hello ${serverRenderer.exports.ssrInterpolate(name.value)} ${serverRenderer.exports.ssrInterpolate(jora.value)} <br>`);
